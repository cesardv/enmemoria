<template>
        ...
        <li><NuxtLink to="/"><span class="icon">
          ...
          </span><span class="menu">Guido</span></NuxtLink></li>
        <li><NuxtLink to="/order-of-service"><span class="icon">
          ...
          </span><span class="menu"><span>Servicio de </span>Misa</span></NuxtLink></li>
        <li><NuxtLink to="/gallery"><span class="icon">
          ...
          </span><span class="menu">Galeria de Fotos</span></NuxtLink></li>
      </ul>
